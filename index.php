...
$productos = [
    ["id" => 1, "nombre" => "Licuadora Moulinex LM270558", "precio" => 10.500, "imagen" => "img/licuadora.jpg", "descripcion" => "Licuadora Optimix Plus Roja Moulinex LM270558: Lográ licuados perfectos con sus cuchillas de acero inoxidable, para mezclar, licuar y moler diversos ingredientes.Tiene una capacidad total de 2 litros y una potencia de 500 Watts."],
    ["id" => 2, "nombre" => "Licuadora Peabody 600W PE-LN601", "precio" => 73.950, "imagen" => "img/licuadora2.jpg", "descripcion" => "Licuadora de 600 watts de potencia.Perilla con control de 5 velocidades + función pulso.Cuchillas dentadas de acero inoxidable.Jarra de plástico de 1,5 Lts y resistente a amplias gamas de temperatura.Tapa dosificadora.Hasta 22.000 rpm."],
    ["id" => 3, "nombre" => "Licuadora con Vaso Mix & Go ", "precio" => 161.499, "imagen" => "img/licuadora3.jpg", "descripcion" => "Licuadora con Vaso Mix & Go 1,75 Litros Jarra Vidrio Pica Hielo 1000W SL-BL1402PN."],
    ["id" => 3, "nombre" => "Licuadora con Vaso Mix & Go ", "precio" => 161.499, "imagen" => "img/licuadora3.jpg", "descripcion" => "Licuadora con Vaso Mix & Go 1,75 Litros Jarra Vidrio Pica Hielo 1000W SL-BL1402PN."],
    ["id" => 1, "nombre" => "Licuadora Moulinex LM270558", "precio" => 10.500, "imagen" => "img/licuadora.jpg", "descripcion" => "Licuadora Optimix Plus Roja Moulinex LM270558: Lográ licuados perfectos con sus cuchillas de acero inoxidable, para mezclar, licuar y moler diversos ingredientes.Tiene una capacidad total de 2 litros y una potencia de 500 Watts."],
    ["id" => 2, "nombre" => "Licuadora Peabody 600W PE-LN601", "precio" => 73.950, "imagen" => "img/licuadora2.jpg", "descripcion" => "Licuadora de 600 watts de potencia.Perilla con control de 5 velocidades + función pulso.Cuchillas dentadas de acero inoxidable.Jarra de plástico de 1,5 Lts y resistente a amplias gamas de temperatura.Tapa dosificadora.Hasta 22.000 rpm."],
];
