        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Info. de Contacto</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="ingresa tu contraseña para guardar cambios" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
